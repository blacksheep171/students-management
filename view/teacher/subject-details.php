            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?= $data['title'] ?></td>
                        <td><?= $data['content'] ?></td>
                        <td><?php foreach ($students as $student){
                            echo $student['student_name']. ', ';
                        }
                         ?></td>
                        <td>
                            <a href='add-student.php?subject_id=<?=$data['subject_id']?>&course_id=<?=$data['course_id']?>' class='btn btn-primary btn-sm'>Add Student</a>
                        </td>
                    </tr>
                </tbody>
            </table>
